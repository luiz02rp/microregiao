...
Foram realizadas correlações de Pearson entre as variáveis Crise Existencial, Felicidade, Sentido de Vida e Otimismo. A análise foi conduzida com o pacote psych (Revelle, 2024) no software R (R Core Team, 2023).

# Resultados (esse foi eu quem fez)
